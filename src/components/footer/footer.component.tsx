            ...
            <SectionContainer className="grid grid-cols-1 lg:flex flex-row justify-between items-start gap-[3rem] lg:gap-4 my-8 lg:max-w-[80rem]">
                ...
                <div className="flex flex-col gap-4 items-start justify-start">
                    ...
                    <ul className="flex flex-col items-start justify-start gap-2 lg:flex-row lg:items-center lg:justify-center lg:gap-6 text-light/80">
                        <li><NavLink to={"/"}
                            onMouseDown={() =>handleNavigateToRoute("/")}
                            className={' hover:text-light'}>Accueil</NavLink></li>
                        <li><NavLink to={"/activities"}  onMouseDown={() =>handleNavigateToRoute("/activities")} className={`hover:text-light`}>Nos activites</NavLink></li>
                        <li><NavLink to={"/contact"}  onMouseDown={() =>handleNavigateToRoute("/contact")} className={'hover:text-light'}>Nous contacter</NavLink></li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col gap-4 items-start justify-center">
                    ...
                    <ul className="flex flex-col sm:flex-row items-start sm:items-center justify-start sm:justify-center gap-3 text-light">
                        ...
                        <li className="flex items-center justify-center">
                            <Link to={"https://www.facebook.com/Plastycor"} rel="noopener noreferrer" className="w-[3rem] aspect-square rounded-full bg-dark-variant flex items-center justify-center hover:text-green-variant !transition-all"><FaFacebookF className="text-xl" /></Link>
                        </li>
                        <li className="flex items-center justify-center">
                            <Link to={"https://www.instagram.com/plastycor_rdc_recyclage_dechet/"} rel="noopener noreferrer" className="w-[3rem] aspect-square rounded-full bg-dark-variant flex items-center justify-center hover:text-green-variant !transition-all"><FaInstagram className="text-xl" /></Link>
                        </li>
                        <li className="flex items-center justify-center">
