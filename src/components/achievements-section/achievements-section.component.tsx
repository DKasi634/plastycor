    ...
    return (
        <section className="flex flex-col py-4 ">
            ...
            <div className="bg-green w-full py-[4rem]">
                <SectionContainer>
                    <GridContainerSm className="!gap-y-12">
                        {
                            achievements.map((achievement, index) => (
                                <div className="flex flex-col items-center justify-center gap-3" key={index}>
                                    ...
                                    <h3 className="text-2xl w-full text-center text-light font-bold my-4">{achievement.number}+</h3>
                                    <p className="text-sm w-full text-center text-light">{achievement.label}</p>
                                </div>
                            ))
                        }
